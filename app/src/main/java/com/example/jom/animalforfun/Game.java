package com.example.jom.animalforfun;
...
public class Game extends AppCompatActivity {
    ...
    public void choiceAns(View view){ //Method สำหรับตรวจคำตอบ
        ...
        String buttonString = button.getText().toString(); //ทำหน้าที่เก็บข้อความบนปุ่มลงตัวแปร button string
        if (buttonString.equals(answer)) {
            score++;
        }
        //chk ว่าตอบครบทุกข้อหรือยัง
        if (qID.isEmpty()){     //ถ้าทำครบแล้ว
            dialogBoxScore();
        }else{                  //ถ้าทำไม่ครบไปเรียกคำถามข้อถัดไป
            setQuestion(qID.remove(0));
        }
        ...
        builder.setMessage("คุณได้คะแนน " + score + "คะแนน")
            ...
            .setPositiveButton("ออกจากเกม", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    finish(); //ออกจากหน้า Activity เกม หรือ ออกจากเกมไปเลย
                }
            })
